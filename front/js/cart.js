...
if (basket !== null) {
  ...
  fetch("http://localhost:3000/api/products/")
    ...
    .catch((error) => {
      alert(
        "Une erreur s'est produite lors du chargement de votre panier. Veuillez vérifier votre connexion internet et rafraichir la page svp."
      );
      console.log(error);
    });
  ...
  buttonCommander.addEventListener("click", (event) => {
    ...
    if ((basket == null) | (basket == undefined) | (basket.length == 0)) {
      ...
      if (
        ...
        alert(
          "Attention ! Tous les champs du formulaire doivent être remplis."
        );
      }
      ...
      // Si les champs du formulaire ne sont pas correctement remplis, on affiche un message d'erreur.
        ...
        alert(
          "Un problème est présent dans votre formulaire de contact, veuillez le remplir correctement."
        );
      }
      ...
      // Si tous les champs sont remplis correctement les informations sont transmises au "Panier".
        ...
        fetch("http://localhost:3000/api/products/order", options)
          ...
          .catch((err) => {
            ...
            alert(
              "Nous rencontrons actuellement un problème technique, veuillez réitérer votre commande ultérieurement."
            );
          });
  ...
  alert(
    "Votre panier est vide, veuillez sélectionner un article pour continuer."
  );
}
